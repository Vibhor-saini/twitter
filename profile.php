...
<script src="assets/js/jquery-3.5.1.min.js"></script>
        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/assets/images/twitter_logo.jpg"; ?>" alt="" height="30px" width="30px" />
            </div>
          </div>
          ...
          <a href="home.php" class="button-twittear">
            <strong>Tweet</strong>
         </a>
    ...
    <div class="col-md-4">
        <li class="">
            ...
            <a href="https://www.google.com/maps?q=<?php echo urlencode($profileData->location); ?>" target="_blank">
                <?php echo $profileData->location; ?>
            </a>
        </li>
    </div>
<?php } ?>
